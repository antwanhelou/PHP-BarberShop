  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <strong><a class="nav-link" href="Shop.php">Shop</a></strong>
        </li>
    ...
    <ul class="navbar-nav">
     ...
     echo '
      ...
      <a class="dropdown-item text-white bg-dark" href="profile.php">My profile</a>
        ...
        <li>
          <a class="dropdown-item text-white bg-dark" href="test.php">Book An Appointment</a>
        </li>
        <li>
          <a class="dropdown-item text-white bg-dark" href="appointments.php">My Appointments</a>
        </li>
        <li>
          <a class="dropdown-item text-white bg-dark" href="historyorders.php">History Of Orders</a>
        </li>
        <li>
